          ...
          return (
            <div
              ...
              className={cn(
                ...
                isToday
                  ? "bg-sky-50 dark:bg-sky-900/20 -mx-2 px-4"
            ...
            >
              ...
              <div className="flex items-center gap-2 w-36 shrink-0">
                ...
                {day.prob > 0 && (
                  <div className="flex items-center gap-0.5 text-xs font-medium text-sky-500">
                    <Droplets size={10} />
                    {day.prob}%
                  </div>
                )}
              ...
              <div className="flex-1 flex items-center gap-2 min-w-0">
                <span className="text-xs text-slate-400 w-8 text-right shrink-0">{day.low}°</span>
                ...
                <span className="text-xs font-semibold text-slate-700 dark:text-slate-200 w-8 shrink-0">{day.high}°</span>
              </div>
            </div>
          );
        })}
